...
void testCases() {
    ...
    allPass = errorTest("Operators Without Operands 2", "((2-) 1 + 3)",  "Invalid operator usage.") && allPass;
    allPass = errorTest("Operators Without Operands 3", "((4 * 2) + ( - ))", "Invalid operator usage.") && allPass;
    allPass = test("Multiply by Zero", "4 % 2 (1) + 3 ** 5", 243) && allPass;
    allPass = test("Exponent and Modulo 1", "2 ** 5 % 4", 0) && allPass;
    ...
    allPass = test("Exponent and Modulo 2", "72 % 7 ** 2", 23) && allPass;
    ...
    allPass = errorTest("Operators Without Operands 4", "**7+3", "Invalid operator usage.") && allPass;
    allPass = errorTest("Operators Without Operands 5", "% 5 - (9-0) /2 +5", "Invalid operator usage.") && allPass;
